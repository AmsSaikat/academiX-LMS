...
export default function CardPage() {
  ...
  return (
    <div className='relative flex items-center justify-center flex-col'>
      ...
      <span className='lg:w-[50%] md:w-[80%] text-[15px] text-center mt-[30px] mb-[30px] px-[20px]'>Explore top-rated courses designed to boost your skills,enhancing your career & 
        unlock opportunities in tech,AI and beyond
      </span>
